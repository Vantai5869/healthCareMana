...
const ServiceGroupPage = () => {
  ...
  useEffect(() => {
    const tmp = data ? data.findAllBranchServices.edges.map(
      i => i.node
    ) : []
    setBranch(tmp)
  }, [data])
            ...
            <div onClick={() => handleView(params.row)}>
              <Modal>
                ...
                <div className='modal-view-branch' style={{ width: 500, paddingBottom: 50 }}>
                  ...
                  <TextField name="price" label="Giá" type={'number'} fullWidth value={currentBranch.price} onChange={handleChange} />
